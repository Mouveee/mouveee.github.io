...
export default function Skills() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-pink-400 opacity-30 rounded-full transform rotate-45 animate-pulse z-0"></div>
      <div className="fixed top-1/3 left-1/4 w-2/3 h-2/3 bg-pink-400 opacity-10 rounded-full transform rotate-30 animate-pulse z-0"></div>
      <div className="fixed top-1/3 left-1/2 w-1/2 h-1/4 bg-pink-400 opacity-5 rounded-full transform rotate-60 animate-pulse z-0"></div>

      {/* Curved, flowing elements in background */}
      <div className="fixed top-1/6 left-1/6 w-3/4 h-1/3 bg-pink-300 opacity-20 rounded-full transform rotate-45 animate-pulse z-0"></div>
      <div className="fixed top-1/3 left-1/4 w-2/5 h-2/5 bg-pink-300 opacity-10 rounded-full transform rotate-30 animate-pulse z-0"></div>
      <div className="fixed top-1/4 left-1/3 w-1/3 h-1/3 bg-pink-300 opacity-5 rounded-full transform rotate-60 animate-pulse z-0"></div>
    </div>
  );
}
